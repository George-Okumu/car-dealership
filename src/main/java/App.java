...
public class App {
    public static void main(String[] args) {
        ...
        Vehicle bmw = new Vehicle(2015, "BMW", "Legacy", 600000, 10000);
        Vehicle crossover = new Vehicle(1998,"Toyota", "RAV-4", 20000, 3500);
        ...
        while(programRunning){
            ...
            if (navigationChoice.equals("All Vehicles")){
                ...
                System.out.println( userVehicle.getmPrice() );
            } else if (navigationChoice.equals("Exit")) {
                programRunning = false;
            } else {
                System.out.println(" Sorry! No option for that");
            }
        }
